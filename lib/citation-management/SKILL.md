...
If a citation workflow needs a diagram and the user requests one, use
`figure-composer`; keep this skill focused on citation quality and verification.
