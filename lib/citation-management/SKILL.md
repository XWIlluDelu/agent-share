...
license: MIT License
required_environment_variables: [{"name": "NCBI_EMAIL", "prompt": "Email for NCBI Entrez identification.", "required_for": "optional PubMed features"}, {"name": "NCBI_API_KEY", "prompt": "NCBI API key to raise Entrez rate limits.", "required_for": "optional PubMed features"}]
---
...
Add figures only when they clarify citation workflows or the user asks for them. Use `figure-composer` for figure-deck composition or schematic planning; keep this skill focused on citation quality, formatting, and verification.

Useful figure types:
- Citation network diagrams
- Literature search flowcharts
