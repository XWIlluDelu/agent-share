...
The CLI is the agent's command layer. It should turn a service, app, API, log source, or database into shell commands agents can run repeatedly from any repo.
