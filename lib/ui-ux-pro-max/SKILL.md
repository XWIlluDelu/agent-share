---
name: ui-ux-pro-max
description: "UI/UX design intelligence for web and mobile backed by a searchable local database of styles, color palettes, font pairings, product types, UX guidance, chart patterns, and stack-specific practices. Use when designing, building, or reviewing UI: pages, components, color schemes, typography, layout, accessibility, animation, responsive behavior, or data visualization."
---

# UI/UX Pro Max - Design Intelligence

Comprehensive design guide for web and mobile applications. Its searchable local database covers styles, palettes, typography, product patterns, UX guidance, charts, and stack-specific practices with priority-based recommendations.
...
Resolve `<skill-dir>` as the directory containing this `SKILL.md`. Search specific domains with the bundled CLI; its `--help` output is authoritative when the live data and examples differ.
...
```bash
python3 <skill-dir>/scripts/search.py "<keyword>" --stack <your-stack>
...
```bash
python3 <skill-dir>/scripts/search.py "list performance navigation" --stack nextjs
```
