...
Add figures only when they clarify the review structure or the user asks for them. Use `figure-composer` for figure-deck composition or schematic planning; keep this skill focused on review quality and critique.

Useful figure types:
- Review framework diagrams
- Study-design critique flowcharts
- Manuscript structure maps
