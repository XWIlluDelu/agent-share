...
Prefer scaffolding from the bundled templates or `new_notebook.py` (for example, `$JUPYTER_NOTEBOOK_SKILL_DIR/scripts/new_notebook.py`) instead of hand-authoring raw notebook JSON.
