...
> **Cold backup** of the getdesign `dell-1996` source spec, captured verbatim via
> `npx getdesign@latest add dell-1996`. This is the reference, not the active contract
> — the panel's active design contract is `panel-design.md`, which adapts this language
> to a dense, editable canvas.
